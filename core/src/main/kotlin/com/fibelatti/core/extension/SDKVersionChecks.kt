...
fun inLollipopOrLater(body: () -> Unit) {
...
fun inLollipopMr1OrLater(body: () -> Unit) {
...
fun inMarshmallowOrLater(body: () -> Unit) {
...
fun inNougatMr1OrLater(body: () -> Unit) {
